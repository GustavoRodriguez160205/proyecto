        ...
        <Container>
          <Row>
            <Col>
              ...
              <hr className="lineaEstilo" />
              <div className="parrafoContainer">
                <p className="parrafoEstilo">
                  Disfruta del mejor fútbol con nuestras canchas de Fútbol 5
                  ¡Bienvenido a nuestro centro de alquiler de canchas para
                  disputar encuentros rápidos pero intensos.
                </p>
              </div>
            </Col>
            <Col>
              ...
              <div className="parrafoContainer">
                <p className="parrafoEstilo">
                  Vive la emoción del fútbol con nuestras canchas de Fútbol 7 En
                  nuestro centro de alquiler de canchas, te ofrecemos el espacio
